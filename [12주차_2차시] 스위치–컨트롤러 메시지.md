...
- ICMP Echo Request Header (8 b**ytes**)
...
### Ping Request 전체 길이 : 98 b**ytes**

```
Ethernet(14) + IP(20) + ICMP(8 + 56) = 98 b**ytes**
...
- 이 패킷(**Ping Request)**을 보고 **FlowTable**에서 **L2 포워딩 룰**을 찾다가 없으면 **PacketIn**을 발생
